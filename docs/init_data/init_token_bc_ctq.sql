...
INSERT INTO `tsys_config`(type, ckey, cvalue, updater, update_datetime, remark) VALUES ('1','curTrxBlockNumber','0','admin',now(),'TRX下次从哪个区块开始扫描');
...
INSERT INTO `tsys_config`(type, ckey, cvalue, updater, update_datetime, remark) VALUES ('0','blockConfirmTrx','0','admin',now(),'TRX需要多少个区块确认');
