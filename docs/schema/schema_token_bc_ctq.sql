...
-- ----------------------------
--  Table structure for `tctq_btc_address`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_btc_utxo`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_eth_address`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_eth_transaction`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_sc_address`
-- ----------------------------
DROP TABLE IF EXISTS `tctq_sc_address`;
...
-- ----------------------------
--  Table structure for `tctq_sc_transaction`
-- ----------------------------
DROP TABLE IF EXISTS `tctq_sc_transaction`;
...
-- ----------------------------
--  Table structure for `tctq_token_address`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_token_contract`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_token_transaction`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_wan_address`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_wan_transaction`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_wtoken_address`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_wtoken_contract`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `tctq_wtoken_transaction`
-- ----------------------------
